"""MCP client: connects to MCP servers and wraps their tools as native merobot tools."""
...
from merobot.agent.tools.base import Tool
from merobot.agent.tools.registry import ToolRegistry


class MCPToolWrapper(Tool):
    """Wraps a single MCP server tool as a merobot Tool."""
